...
<head>
    ...
    <link rel="stylesheet" href="{{url('landingFrontendFiles/css/userProject.css')}}">
    <!-- box icon -->
...
<body style="background-image: url({{url('landingFrontendFiles/images/backgroundimage.jpg')}}); background-size: cover;background-repeat: no-repeat; background-attachment: fixed;background-position: center;">
    ...
    <a href="{{url('/home')}}" class="logo"><i class='bx bx-arrow-back'></i></a>
        ...
        <nav class="navbar">
            <a href="{{route('customhome',['id'=> $uid])}}">Home</a>
            <a href="{{route('customhome',['id'=> $uid])}}#about">About</a>
            <a href="{{route('customhome',['id'=> $uid])}}#education">Education</a>
            <a href="{{route('customhome',['id'=> $uid])}}#skills">Skills</a>
            <a href="{{route('customprojects',['id'=> $uid])}}" class="active">Projects</a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-button"style="">
                                ...
                                <div class="see-more-project">
                                    <a href="{{route('usersingleProject',['id'=> $uid,'pid'=>$projectAbout->projectId])}}">View</a>
                                </div>
