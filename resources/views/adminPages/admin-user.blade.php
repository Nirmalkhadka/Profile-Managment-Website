...
<head>
    ...
    <title>PortfolioHub | AdminUsers</title>
              ...
              <div class="movies-data-container">
                ...
                <td>
                  <div class="info-container">
                    <img src="{{asset('/images/AdminProfilePic/'.$alluser->profilePic)}}" class="user-image-data">
                ...
                <td style="text-align: right;">
                  <div class="action-container">
                    ...
                    <a href="{{route('deleteinadmin',['id'=> $alluser->profile_uid])}}"><i class='bx bxs-trash delete-icon' ></i></a>
                  </div>
                </td>
              </div>
